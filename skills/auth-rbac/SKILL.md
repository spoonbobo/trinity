...
## YAML Registry (`src/rbac/permissions.yaml`)

Three identical copies at: `src/rbac/`, `src/auth-service/rbac/`, `src/terminal-proxy/rbac/`
...
1. Add to `src/supabase/migrations/003_seed_permissions.sql`
2. Add to `src/rbac/permissions.yaml` (all 3 copies)
3. Add to `src/frontend/lib/core/rbac_constants.dart`
